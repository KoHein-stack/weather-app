...
/**
 * ForecastSection: Implements the advanced line graph design using react-native-gifted-charts.
 * Features dual curves for High/Low temperatures with data points and a detailed info row.
 */
export default function ForecastSection({ data, unit }: ForecastSectionProps) {
    ...
    const getWeatherIcon = (main: string): keyof typeof Ionicons.glyphMap => {
                ...
                <View>
                    <View style={styles.chartWrapper}>
                        <LineChart
                            ...
                            thickness2={2}
                            curved
                            curveType={1} // 1: Catmull
                            hideRules
                            hideAxesAndRules
                            hideYAxisText
                            yAxisLabelWidth={0} // Remove space for Y axis
                            yAxisThickness={0}
                            xAxisThickness={0}
                            maxValue={maxVal + 5}
                    ...
                    {/* Info Row: Icons and Dates aligned with chart points */}
...
const styles = StyleSheet.create({
    ...
    chartWrapper: {
        // Ensuring no extra horizontal offsets
        marginLeft: 0,
        paddingLeft: 0,
    },
    infoRow: {
